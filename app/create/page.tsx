  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const newPin: Pin = {
        ...
        image_url: imageUrl || `/placeholder.svg?height=400&width=300&query=${encodeURIComponent(title)}`,
            ...
            <CardContent className="space-y-4">
              ...
              {activeTab === "upload" ? (
                <div className="border-2 border-dashed border-border rounded-lg p-8 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">Recommended: 2:3 aspect ratio, less than 20MB</p>
